...
@WebServlet( urlPatterns =  "/loadHotelForm")
public class LoadHotelForm extends HttpServlet {
...
private HotelService hotelService = new HotelServiceImp();
	...
	RequestDispatcher ds = this.getServletContext().getRequestDispatcher("/HotelForm.jsp");
