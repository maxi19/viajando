...
@WebServlet( urlPatterns =  "/paqueteEliminar")
public class PaqueteEliminar extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (id == null || id.trim().isEmpty()) {
            ...
            req.getRequestDispatcher("/loadPaqueteFormBaja").forward(req, resp);
            return;     
        }
        
        int idInt = Integer.parseInt(id);
        try {
		  paqueteService.delete(idInt);
