...
public interface ExcursionDao {
    ...
    public int saveAndReturnId(String nombre, String descripcion, LocalDate fechaInicio, LocalDate fechaFin, int precio, int destino_id, double estrellas) throws Exception;
